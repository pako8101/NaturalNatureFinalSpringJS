document.addEventListener('DOMContentLoaded', function () {
    const articles = [
        ...
        { id: 11, title: "Herbal Remedies for Natural Healing", summary: "Learn about herbs remedies that support natural healing.", content: "<p>Herbs like chamomile, ginger, and turmeric have been used for centuries to treat various ailments naturally...</p>", image: "/images/herbs-remedies.jpg" },
